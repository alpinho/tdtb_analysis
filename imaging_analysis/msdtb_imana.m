        ...
        for s = sn
            ...
            for ses = 1:length(raw_sestag)
                ...
                func_folder = fullfile(base_dir, raw_dir, subj_str{s}, ...
                    raw_sestag{ses}, func_dir);
                fmap_folder = fullfile(base_dir, raw_dir, subj_str{s}, ...
                    raw_sestag{ses}, fmap_dir);
                mag_file = sprintf(...
                    '%s_%s_magnitude1.nii', subj_str{s}, raw_sestag{ses});
                phase_file = sprintf(...
                    '%s_%s_phasediff.nii', subj_str{s}, raw_sestag{ses});
                ...
                for r=1:length(raw_sesrun{ses})
                    ...
                    func_data = fullfile(func_folder, [func_files '.gz']);
                    gunzip(func_data, localscratch);
                    if ~isequal(raw_sesrun{ses}{r}, preproc_sesrun{ses}{r})
                ...
                fmap_deriv = fullfile(base_dir, derivatives_dir, ...
                    subj_str{s}, preproc_sestag{ses}, fmap_dir);
                % Create/update destination folder
                folder(fmap_deriv);
                % Move files from localscratch to derivatives folder
                movefile([localscratch '/bmask' preproctag ...
                    '_magnitude' num2str(magnumber, '%d') '.nii'], ...
                    fmap_deriv);
                movefile([localscratch '/fpm_sc' preproctag ...
                    '_phasediff.nii'], ...
                    fmap_deriv);
                movefile([localscratch '/m' preproctag ...
                    '_magnitude' num2str(magnumber, '%d') '.nii'], ...
                    fmap_deriv);
                movefile([localscratch '/sc' preproctag ...
                    '_phasediff.nii'], ...
                    fmap_deriv);
                movefile([localscratch '/u' preproctag ...
                    '_task-*_run-*_bold.nii'], ...
                    fmap_deriv);
                movefile([localscratch '/vdm5_sc' preproctag ...
                    '_phasediff.nii'], ...
                    fmap_deriv);
                for r=1:length(preproc_sesrun{ses})
                    movefile([localscratch '/vdm5_sc' preproctag ...
                        '_phasediff_run' num2str(r, '%d') '.nii'], ...
                        fullfile(fmap_deriv, ['vdm5_sc' preproctag ...
                        '_phasediff_' ...
                        preproc_sesrun{ses}{r} '.nii']));
                end
                movefile([localscratch '/wfmag_' preproctag ...
                    '_task-*_run-*_bold.nii'], fmap_deriv);
