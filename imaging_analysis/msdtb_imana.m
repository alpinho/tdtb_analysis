    ...
    case 'FUNC:make_fieldmap' % Make fieldmap
        ...
        for s = sn
            ...
            for ses = 1:length(raw_sestag)
                ...
                mag_file = sprintf('%s_magnitude1.nii', rawtag);
                phase_file = sprintf('%s_phasediff.nii', rawtag);
                ...
                % Rename session tag of magnitude and phase files from one
                % to two digits, if that is the case
