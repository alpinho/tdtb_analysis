...
if strcmp(subj_str{s}, 'sub-14')
    session_names = {'ses-01', 'ses-02', 'ses-03'};
else
    ...
    case 'FUNC:make_fieldmap' % Make fieldmap
        ...
        for s = sn
            for ses = ssn 
                ...
                % Renumber Prod and NTFDrand runs for sub-14 ses-03
                if strcmp(subj_str{s}, 'sub-14') && ses == 3
                    for rn=1:length(run)
                        task_id = run{rn}(6:9);
                        run_n = str2num(run{rn}(end-1:end));
                        if strcmp(task_id, 'prod')
                            increment = 1;
                        elseif strcmp(task_id, 'ntfd')
                            increment = 2;
                        end                    
                        movefile(fullfile(fmap_deriv, ...
                            ['u' subj_str{s} ...
                            '_ses-' num2str(ses, '%02d') ...
                            '_task-' task_id ...
                            '_run-' num2str(run_n, '%02d') ...
                            '_bold.nii']), ...
                            fullfile(fmap_deriv, ...
                            ['u' subj_str{s} ...
                            '_ses-' num2str(ses, '%02d') ...
                            '_task-' task_id ...
                            '_run-' num2str(run_n+increment, '%02d') ...
                            '_bold.nii']));
                        movefile(fullfile(fmap_deriv, ...
                            ['vdm5_sc' subj_str{s} ...
                            '_ses-' num2str(ses, '%02d') ...
                            '_phasediff_task-' task_id ...
                            '_run-' num2str(run_n, '%02d') '.nii']), ...
                            fullfile(fmap_deriv, ...
                            ['vdm5_sc' subj_str{s} ...
                            '_ses-' num2str(ses, '%02d') ...
                            '_phasediff_task-' task_id ...
                ...
                % Renumber NTFD runs for sub-18 ses-01
                elseif strcmp(subj_str{s}, 'sub-18') && ses == 1
                    ntfd18 = dir(fullfile(localscratch, ...
                        'sub-18_ses-01_task-ntfd_run-*_bold.nii'))
                    for rn=1:length(ntfd18)
                        movefile(fullfile(fmap_deriv, ...
                            ['u' subj_str{s} ...
                            '_ses-' num2str(ses, '%02d') ...
                            '_task-ntfd' ...
                            '_run-' num2str(rn+2, '%02d') ...
                            '_bold.nii']), ...
                            fullfile(fmap_deriv, ...
                            ['u' subj_str{s} ...
                            '_ses-' num2str(ses, '%02d') ...
                        ...
                        movefile(fullfile(fmap_deriv, ...
                            ['vdm5_sc' subj_str{s} ...
                            '_ses-' num2str(ses, '%02d') ...
                            '_phasediff_task-ntfd' ...
                            '_run-' num2str(rn+2, '%02d') '.nii']), ...
                            fullfile(fmap_deriv, ...
                            ['vdm5_sc' subj_str{s} ...
                            '_ses-' num2str(ses, '%02d') ...
                            '_phasediff_task-ntfd' ...
                ...
                % Renumber NTFD runs for sub-32 ses-01
                elseif strcmp(subj_str{s}, 'sub-32') && ses == 1
                    ntfd32 = dir(fullfile(localscratch, ...
                        'sub-32_ses-01_task-ntfd_run-*_bold.nii'))
                    for rn=1:length(ntfd32)
                        movefile(fullfile(fmap_deriv, ...
                            ['u' subj_str{s} ...
                            '_ses-' num2str(ses, '%02d') ...
                            '_task-ntfd' ...
                            '_run-' num2str(rn+5, '%02d') ...
                            '_bold.nii']), ...
                            fullfile(fmap_deriv, ...
                            ['u' subj_str{s} ...
                            '_ses-' num2str(ses, '%02d') ...
            ...
            for ses = ssn
                ...
                for tk=1:length(tasks)
                    ...
                    for r=1:n_run
                        ...
                        % Filename of VDM file and set run array
                        if strcmp(subj_str{s}, 'sub-14') && ses == 3 && ...
                                strcmp(tasks{tk}, 'prod')
                            fmap_fname = sprintf(...
