        ...
        for s = sn
            for ses = ssn
                ...
                elseif strcmp(subj_str{s}, 'sub-18') && ses == 1
                    n_ntfd = dir(fullfile(localscratch, ...
                        'sub-18_ses-01_task-ntfd_run-*_bold.nii'))
                    for rn=1:length(n_ntfd)
                        movefile(fullfile(fmap_deriv, ...
                            ['u' subj_str{s} ...
                            '_ses-' num2str(ses, '%02d') ...
                            '_task-' task_id ...
                            '_run-' num2str(n_ntfd+2, '%02d') ...
                            '_bold.nii']), ...
                            fullfile(fmap_deriv, ...
                            ['u' subj_str{s} ...
                            '_ses-' num2str(ses, '%02d') ...
                            '_task-' task_id ...
                            '_run-' num2str(n_ntfd, '%02d') ...
                            '_bold.nii']));
                        movefile(fullfile(fmap_deriv, ...
                            ['vdm5_sc' subj_str{s} ...
                            '_ses-' num2str(ses, '%02d') ...
                            '_phasediff_task-' task_id ...
                            '_run-' num2str(n_ntfd+2, '%02d') '.nii']), ...
                            fullfile(fmap_deriv, ...
                            ['vdm5_sc' subj_str{s} ...
                            '_ses-' num2str(ses, '%02d') ...
                            '_phasediff_task-' task_id ...
